...
public class AllTimeLeadersController implements Initializable {
    @FXML
    public TableView<CurrentLeader> allTimeSalesTable;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        setupAllTimeSalesTableColumns();
        loadDataIntoAllTimeSalesTable();
    }

    private void setupAllTimeSalesTableColumns() {
    ...
    private void loadDataIntoAllTimeSalesTable() {
        allTimeSalesTable.getItems().clear();
        ...
        try (PreparedStatement statement = connection.prepareStatement(selectQuery);
            ...
            ObservableList<CurrentLeader> allTimeLeadersList = FXCollections.observableArrayList();
            int ranking = 1;
            int id = 1;
            ...
            while (resultSet.next()) {
                ...
                CurrentLeader allTimeLeader = new CurrentLeader(id, employee, totalQuantity, ranking, transactionCount);
                allTimeLeadersList.add(allTimeLeader);

                id++;
                ranking++;
            }

            allTimeSalesTable.setItems(allTimeLeadersList);
